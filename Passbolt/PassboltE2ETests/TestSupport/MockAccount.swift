...
extension MockAccount {
  ...
  //    When testing locally you can use your "PASSPHRASE" environment variable. You can set it for your UITestPlan.xctestplan in "Configurations" >> Shared settings >> Environment Variables
  internal static var automation: Self {
    .init(
      ...
      armoredKey:  // removed all newlines and armor header and footer (those can't be properly passed)
