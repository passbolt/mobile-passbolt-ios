...
final internal class TransferAccountDetailsScreen: Screen {
  ...
  internal lazy var scanDescription: XCUIElement =
    self.application.staticTexts["Scan the qr codes sequence"]
  internal lazy var startTransferButton: XCUIElement =
    self.application.buttons["transfer.account.export.scan.qr.button"]
}
