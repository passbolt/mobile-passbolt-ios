...
#warning("[MOB-1301] TODO: ResourceEditController is about to be rewritten - disabling tests for now")
...
//    super.commonPrepare()
//    patch(
//      \LegacyResourceEditForm.fieldsPublisher,
//      with: always(
...
//      self.dynamicVariables.get(\.resultPassword)
//    }
//    var resultGenerate:
//      (
