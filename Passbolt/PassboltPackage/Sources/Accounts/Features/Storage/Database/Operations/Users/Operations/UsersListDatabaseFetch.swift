...
public struct UsersListDatabaseFetch {

  public var execute: @StorageAccessActor (UsersFilter) async throws -> Array<UserDetailsDSV>
...
extension UsersListDatabaseFetch: DatabaseOperationFeature {
