...
/// Storage for account lifecycle operations including creation, deletion, and data integrity verification.
public struct AccountsListStorage: Sendable {
...
extension AccountsListStorage: LoadableFeature {
