...
internal struct ResourcesListController {
  ...
  internal var resourcesListPublisher: () -> AnyPublisher<Array<ListViewResource>, Never>
  internal var addResource: () -> Void
  internal var presentResourceDetails: (ListViewResource) -> Void
  internal var presentResourceMenu: (ListViewResource) -> Void
}
...
extension ResourcesListController: UIController {
  ...
  internal static func instance(
    ...
    func resourcesListPublisher() -> AnyPublisher<Array<ListViewResource>, Never> {
