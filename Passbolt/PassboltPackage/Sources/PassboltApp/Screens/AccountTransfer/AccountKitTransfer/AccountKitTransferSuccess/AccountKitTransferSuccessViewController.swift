...
internal final class AccountKitTransferSuccessViewController: PlainViewController, UIComponent {

  internal typealias ContentView = ResultView
  internal typealias Controller = AccountKitTransferSuccessController
  ...
  internal func setupView() {
    ...
    contentView
      .applyOn(
        title: .text(displayable: .localized(key: "transfer.account.kit.result.success.title"))
      )
    contentView
      .applyOn(
        button: .combined(
