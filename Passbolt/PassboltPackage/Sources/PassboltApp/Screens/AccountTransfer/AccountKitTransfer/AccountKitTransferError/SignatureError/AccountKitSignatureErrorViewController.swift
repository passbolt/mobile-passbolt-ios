...
internal final class AccountKitSignatureErrorViewController: PlainViewController, UIComponent {
  ...
  internal func setupView() {
    ...
    contentView
      .applyOn(
        title: .text(displayable: .localized(key: "error.account.kit.signature.verification"))
      )
    contentView
      .applyOn(
        button: .combined(
