...
internal final class AccountKitImportFailureViewController: PlainViewController, UIComponent {
  ...
  internal func setupView() {
    ...
    contentView
      .applyOn(
        title: .text(displayable: .localized(key: "error.account.kit.fail.to.import"))
      )
    contentView
      .applyOn(
        button: .combined(
