...
internal final class ExpiredResourcesListViewController: PlainViewController, UIComponent {

  internal typealias ContentView = ExpiredResourcesListView
  internal typealias Controller = ExpiredResourcesListController
  ...
  private func setupNavigationBar() {
    ...
    mut(titleImage) {
      .combined(
        .image(
          named: HomePresentationMode.expiredResourcesList.iconName,
          from: .uiCommons
        ),
    ...
    mut(titleLabel) {
      .combined(
        .text(displayable: HomePresentationMode.expiredResourcesList.title),
