...
internal final class SharedResourcesListViewController: PlainViewController, UIComponent {

  internal typealias ContentView = SharedResourcesListView
  internal typealias Controller = SharedResourcesListController
  ...
  private func setupNavigationView() {
    ...
    mut(titleImage) {
      .combined(
        .image(
          named: HomePresentationMode.sharedResourcesList.iconName,
          from: .uiCommons
        ),
    ...
    mut(titleLabel) {
      .combined(
        .text(displayable: HomePresentationMode.sharedResourcesList.title),
