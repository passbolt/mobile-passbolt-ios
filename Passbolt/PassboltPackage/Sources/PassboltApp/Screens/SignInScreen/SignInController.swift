...
extension SignInController: UIController {
  ...
  internal static func instance(
    ...
    return Self(
      ...
      validatedPassphrasePublisher: passphrase.map(validator.validate).eraseToAnyPublisher,
      presentForgotPassphraseAlertPublisher: { presentForgotAlertPublisher.eraseToAnyPublisher() }
    )
  }
}
