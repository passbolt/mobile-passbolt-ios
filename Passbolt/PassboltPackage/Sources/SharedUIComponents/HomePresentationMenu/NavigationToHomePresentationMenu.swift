...
public enum NavigationToHomePresentationMenuDestination: NavigationDestination {

  public typealias TransitionContext = Void
}

public typealias NavigationToHomePresentationMenu = NavigationTo<NavigationToHomePresentationMenuDestination>
