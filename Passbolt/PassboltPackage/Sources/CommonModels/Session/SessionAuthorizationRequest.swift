...
public enum SessionAuthorizationRequest {
  ...
  /// MFA authorization is required.
  case mfa(Account, providers: Array<SessionMFAProvider>)
}

extension SessionAuthorizationRequest {
...
extension SessionAuthorizationRequest: Hashable {}
