...
extension ResourceUpdateFolderDatabaseOperation {

  @Sendable fileprivate static func execute(
    _ input: ResourceUpdateFolderDatabaseOperationDSO,
    ...
    try connection.execute(
      .init(
        ...
        WHERE
          id = ?2;
        """,
        arguments: [input.folderID?.rawValue, input.resourceID.rawValue]
      )
    )
  }
}
