...
extension FeaturesRegistry {
  ...
  public mutating func usePassboltNetworkOperationsModule() {
    ...
    self.usePassboltResourceFetchNetworkOperation()
    self.usePassboltResourceFolderFetchNetworkOperation()
    ...
    self.usePassboltUserGroupsFetchByIDsNetworkOperation()
    self.usePassboltUserDetailsFetchNetworkOperation()
    self.usePassboltUsersFetchNetworkOperation()
    self.usePassboltUsersFetchByIDsNetworkOperation()
    ...
    self.usePassboltPasswordExpirySettingsFetchNetworkOperation()
  }
}
