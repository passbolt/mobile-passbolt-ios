...
extension ResourceFetchNetworkOperation {
...
extension FeaturesRegistry {
  ...
  internal mutating func usePassboltResourceFetchNetworkOperation() {
    self.use(
      .networkOperationWithSession(
        of: ResourceFetchNetworkOperation.self,
        requestPreparation: ResourceFetchNetworkOperation.requestPreparation(_:),
        responseDecoding: ResourceFetchNetworkOperation.responseDecoder(_:_:)
      )
    )
  }
}
