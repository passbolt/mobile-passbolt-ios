...
extension ResourceSecretFetchNetworkOperation {
  ...
  internal mutating func usePassboltResourceSecretFetchNetworkOperation() {
    self.use(
      .networkOperationWithSession(
        ...
        requestPreparation: ResourceSecretFetchNetworkOperation.requestPreparation(_:),
        responseDecoding: ResourceSecretFetchNetworkOperation.responseDecoder(_:_:)
      )
    )
  }
}
