...
extension ResourceFolderCreateNetworkOperation {
  ...
  internal func usePassboltResourceFolderCreateNetworkOperation() {
    self.use(
      .networkOperationWithSession(
        ...
        requestPreparation: ResourceFolderCreateNetworkOperation.requestPreparation(_:),
        responseDecoding: ResourceFolderCreateNetworkOperation.responseDecoder(_:_:)
      )
    )
  }
}
